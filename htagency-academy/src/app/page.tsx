...
const HomePage = () => {
  ...
  return (
    // Applied styling changes from Turn 5 carefully
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-end">
          <div className="flex-1 sm:flex-grow-0 flex flex-col space-y-1.5 min-w-[180px] sm:min-w-[200px]">
            ...
            <Select value={selectedTopic} onValueChange={setSelectedTopic}>
              <SelectTrigger className="w-full" id="topic-filter"> {/* Added id */}
          ...
          <div className="flex-1 sm:flex-grow-0 flex flex-col space-y-1.5 min-w-[180px] sm:min-w-[200px]">
            ...
            <Select value={selectedDifficulty} onValueChange={setSelectedDifficulty}>
              <SelectTrigger className="w-full" id="difficulty-filter"> {/* Added id */}
